...
const hotelKnowledge = fs.readFileSync(
    knowledgePath,
    "utf8"
);
...
If the guest writes their message in a different language and it is clear
they want to communicate in that language, you may follow the language they
are using.
